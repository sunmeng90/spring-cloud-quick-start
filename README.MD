...
The load balance will check health of service by ping, you can set dummy ping to skip for set the specific available health check url, otherwise, the service will not be marked as available.
```java
